...
<div class="content">
    ...
    <div class="body-content">
        ...
        <div class="kt-portlet__body">                
            ...
            <form class="form" action="{{route('ingreso.entrega.update', $product->id)}}" enctype="multipart/form-data" method="post">
            ...
            <form class="form" action="{{ route('ingreso.entrega.uploadFile', $product->id) }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}     
                <div class="row">
                    <div class="form-group">
                        <label for=""> <nav style="color: red;"><i class="icon-upload-alt"></i> Subir documento firmado</nav></label>
                    </div>
                    <div class="marco col-ms-10">
                        <label class="btn btn-default" style="display: flex">
                            <input type="file" name="archivo" class=" btn btn-primary" value="" accept="application/pdf" >
                            <input type="submit" name="submit" value="Guardar" class="btn btn-danger">
                        </label>
                    </div>
                </div>
